...
Current version supports `api_type="openai"` for real calls.
Other types such as "dummy" or "offline" return placeholder content for local smoke checks.
...
class LLMClient:
    ...
    "feedback": "[MOCK] This is a mock evaluation response from the local smoke-check path",
    "pass": true
}'''
...
```'''
                ...
                content = (
                    f"[LLMClient dummy({self.model_name}) response for local checks]\n"
